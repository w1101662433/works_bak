...
def retry_get(retry_times=3, session=None, interval=1, status_codes=None, error_keywords=None, **kwargs):
    return retry_request('GET', retry_times=retry_times, session=session, interval=interval, status_codes=status_codes, error_keywords=None, **kwargs)
...
if __name__ == "__main__":
    res = telnet_it('106.110.106.52','54246')
    print(res)
